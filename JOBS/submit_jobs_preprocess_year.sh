...
# single_year=2083  # Specify the year you want to submit

# # Loop through each simulation
# for sim in "${sims[@]}"; do
#   # Submit a job for the specified year
#   sbatch --export=year=$single_year,sim=$sim --job-name=${sim}_${single_year}_preprocess -o "/home/vdemeyer/TRACKING/KATJA/JOBS/OUTPUTS/${sim}_${single_year}_preprocess.out" /home/vdemeyer/TRACKING/KATJA/JOBS/preprocess_year.sh
# done
